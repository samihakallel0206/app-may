const challenges = [
  {
    ...
    description:
      "Proposez des solutions innovantes pour améliorer la couverture réseau 5G en zone urbaine dense",
    category: "network",
    difficulty: "medium",
    reward: 500,
    participants: 35,
  ...
  },
  {
    ...
    description:
      "Développez une application mobile qui résout un problème quotidien des utilisateurs Ooredoo",
  ...
  },
  {
    ...
    description:
      "Identifiez et proposez des solutions pour renforcer la sécurité des données clients",
    category: "security",
    difficulty: "hard",
    reward: 750,
    participants: 22,
  ...
  },
  {
    ...
    description:
      "Développez une solution IA pour améliorer le service client Ooredoo",
    category: "ai",
    difficulty: "expert",
    reward: 1500,
    participants: 15,
